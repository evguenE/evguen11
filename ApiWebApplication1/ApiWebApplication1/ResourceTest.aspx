...
<%@ Import Namespace="ApiWebApplication1.Properties" %>
<script runat="server">
    ...
    <div class="well container" style="margin-top: 30px;">
        <section class="pull-right" style="text-align: right">
            ...
            <div>
                 ...
                 <form id="form1" action="ResourceTest.aspx" method="GET">
                    <select id="localeId" name="localeId" value="<%= LocaleId %>"                       
        ...
        <div class="container">
            ...
            <label  data-resource-id="UsingDbResAccess"><%=DbRes.T("UsingDbResAccess","Resources") %></label>                                  
