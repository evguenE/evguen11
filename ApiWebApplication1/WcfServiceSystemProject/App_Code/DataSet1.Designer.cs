...
namespace WcfServiceSystemProject.App_Code {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public CustomersRow AddCustomersRow(string Expr1, string Expr2, string Name, string Country) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public CustomersRow FindByExpr3CustomerId(int Expr3, int CustomerId) {
        ...
        public partial class CustomersRow : global::System.Data.DataRow {
            ...
            public string Expr1 {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'Expr1\' in table \'Customers\' is DBNull.", e);
                    }
                }
                set {
            ...
            public int Expr3 {
                get {
                    return ((int)(this[this.tableCustomers.Expr3Column]));
                }
                set {
            ...
            public bool IsExpr1Null() {
                return this.IsNull(this.tableCustomers.Expr1Column);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetExpr1Null() {
                this[this.tableCustomers.Expr1Column] = global::System.Convert.DBNull;
            }
...
namespace WcfServiceSystemProject.App_Code.DataSet1TableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Customers] WHERE (([CustomerId] = @Original_Expr3) AND ([CustomerId]" +
                " = @Original_CustomerId))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Customers] ([Country], [Name], [Name], [Country]) VALUES (@Expr1, @E" +
                "xpr2, @Name, @Country)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Customers] SET [Country] = @Expr1, [Name] = @Expr2, [Name] = @Name, [Coun" +
                "try] = @Country WHERE (([CustomerId] = @Original_Expr3) AND ([CustomerId] = @Ori" +
                "ginal_CustomerId))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["SystemProjectConnectionString"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        Country AS Expr1, Name AS Expr2, CustomerId AS Expr3, Customers.*\r\n" +
                "FROM            Customers";
        ...
        public virtual int Delete(int Original_Expr3, int Original_CustomerId) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_Expr3));
        ...
        public virtual int Insert(string Expr1, string Expr2, string Name, string Country) {
            if ((Expr1 == null)) {
        ...
        public virtual int Update(string Expr1, string Expr2, string Name, string Country, int Original_Expr3, int Original_CustomerId) {
            if ((Expr1 == null)) {
                throw new global::System.ArgumentNullException("Expr1");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(Original_Expr3));
